...
imwrite(z, "beckett_lap.png");    # save output image
\end{verbatim}


\includegraphics{beckett_lap.png}
{\small\verb+beckett_lap.png+}
...
imwrite(reshape(uint8(y),w,h), "beckett_sharp.png");  # save output image
\end{verbatim}
%z = uint8(reshape(y,w,h));          # reshape
%imwrite(z, "beckett_sharp.png");    # save output image

\includegraphics{beckett_sharp.png}
{\small\verb+beckett_sharp.png+}
...
imwrite(reshape(uint8(y),w,h), "beckett_smooth.png");  # save output image
\end{verbatim}
%z = uint8(reshape(y,w,h));          # reshape
%imwrite(z, "beckett_smooth.png");   # save output image

\includegraphics{beckett_smooth.png}
{\small\verb+beckett_smooth.png+}
...
as the adjacency matrix plus the identity.  The implementation of the
dilation operator is thus
...
is perturbed by the zeros in the sparse matrix, which are not ignored).
The implementation of the erosion works by computing the dilation of an image
in the negative:
...
And the implementation of all the operations consists simply in copying the
table above:
...
imwrite(uint8(reshape( 255-6*bothat(E,x)     ,w,h)), "beckett_bot.png");
\end{verbatim}

\includegraphics{beckett_dil.png}{\small\verb+beckett_dil.png+}\\
\includegraphics{beckett_ero.png}{\small\verb+beckett_ero.png+}\\
\includegraphics{beckett_ope.png}{\small\verb+beckett_ope.png+}\\
\includegraphics{beckett_clo.png}{\small\verb+beckett_clo.png+}\\
\includegraphics{beckett_igrad.png}{\small\verb+beckett_igrad.png+}\\
\includegraphics{beckett_egrad.png}{\small\verb+beckett_egrad.png+}\\
\includegraphics{beckett_cgrad.png}{\small\verb+beckett_cgrad.png+}\\
\includegraphics{beckett_mlap.png}{\small\verb+beckett_mlap.png+}\\
\includegraphics{beckett_msharp.png}{\small\verb+beckett_msharp.png+}\\
\includegraphics{beckett_top.png}{\small\verb+beckett_top.png+}\\
\includegraphics{beckett_bot.png}{\small\verb+beckett_bot.png+}\\
...
As a final comment on graph-based morphology, if you want to do {\bf
morphology on binary images}, the implementation can be much simpler.  For
example, the dilation of a mask~$m$ can be computed simply by multiplying by
...
imwrite(logical(reshape(y2,w,h)), "beckett_a6_tm.png");  # save dilated mask
\end{verbatim}

\includegraphics{beckett_bin.png}{\small\verb+beckett_bin.png+}\\
\includegraphics{beckett_a6.png}{\small\verb+beckett_a6.png+}\\
\includegraphics{beckett_a6_t0.png}{\small\verb+beckett_a6_t0.png+}\\
\includegraphics{beckett_a6_tm.png}{\small\verb+beckett_a6_tm.png+}\\
