...
imwrite(uint8(reshape(y,w,h)*f),  "beckett_6gray.png");  # save gray-scale
imwrite(logical(reshape(y1,w,h)), "beckett_6dil.png");   # save dilated mask
imwrite(logical(reshape(y2,w,h)), "beckett_6ero.png");   # save eroderd mask
imwrite(logical(reshape(y3,w,h)), "beckett_6med.png");   # save median filter
\end{verbatim}

\includegraphics{beckett_bin.png}{\small\verb+beckett_bin.png+}\\
\includegraphics{beckett_6gray.png}{\small\verb+beckett_6gray.png+}\\
\includegraphics{beckett_6dil.png}{\small\verb+beckett_6dil.png+}\\
\includegraphics{beckett_6ero.png}{\small\verb+beckett_6ero.png+}\\
\includegraphics{beckett_6med.png}{\small\verb+beckett_6med.png+}\\
