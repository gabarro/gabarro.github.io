...
[w,h] = size(x);                                       # extract dimensions
m = double(x(:) > 66);                                 # flattend and binarize

A = grid_graph(w,h);                                   # adjacency matrix
y = (A^4 * m) > 0;                                     # apply 4 dilations

imwrite(logical(reshape(m,w,h)), "beckett_bin.png");   # save binary mask
imwrite(logical(reshape(y,w,h)), "beckett_mask.png");  # save dilated mask
\end{verbatim}

\includegraphics{beckett_bin.png}{\small\verb+beckett_bin.png+}\\
\includegraphics{beckett_mask.png}{\small\verb+beckett_mask.png+}\\
